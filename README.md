...
Static documentation site for [github.com/gotokart](https://github.com/gotokart), built with [Next.js](https://nextjs.org/) + [Nextra](https://nextra.site/) and fully tailored to GoToKart.
...
- **Live project links:** Includes direct links to your live storefront and repository set.

## Live project

- Frontend: [https://gotokart.github.io/frontend/#](https://gotokart.github.io/frontend/#)
