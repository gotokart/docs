...
> **Interactive diagram** — the full colour-coded swimlane diagram is committed as a draw.io file.
> GitHub renders it natively: [**View architecture.drawio on GitHub →**](https://github.com/gotokart/docs/blob/main/diagrams/architecture.drawio)
