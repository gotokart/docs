...
<iframe
  src="https://viewer.diagrams.net/?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgotokart%2Fdocs%2Fmain%2Fdiagrams%2Farchitecture.drawio&highlight=0000ff&nav=1&title=GoToKart+Architecture"
  style={{width:"100%",height:"520px",border:"1px solid #e5e7eb",borderRadius:"8px"}}
  allowFullScreen
/>

<p style={{fontSize:"0.8rem",color:"#6b7280",marginTop:"0.5rem"}}>
  Swimlane architecture diagram — colour-coded by tier (Client → Source → Runtime → Deploy). &nbsp;
  <a href="https://github.com/gotokart/docs/blob/main/diagrams/architecture.drawio" target="_blank" rel="noreferrer">Open .drawio source on GitHub →</a>
</p>
