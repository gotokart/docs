...
<p className="gk-arch-note">
  Single source architecture diagram (runtime and deployment flow):
</p>

<div className="gk-arch-figure-wrap">
  <img
    src="/assets/gotokart-architecture.svg"
    alt="GoToKart high-level architecture diagram"
    className="gk-arch-figure"
  />
</div>
